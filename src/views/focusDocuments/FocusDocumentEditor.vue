...
.focus-editor-toolbar::-webkit-scrollbar {
  display: none;
}
...
.focus-editor-toolbar select:hover {
  background-color: #f2f4f6;
}

.focus-editor-toolbar button:focus-visible,
.focus-editor-toolbar select:focus-visible,
.focus-bubble button:focus-visible {
  box-shadow: 0 0 0 2px rgba(66, 99, 235, 0.26);
}
...
.linked-task-block {
  ...
  border-radius: 10px;
  background: #fbfcfd;
  box-shadow: 0 1px 2px rgba(24, 29, 38, 0.025);
  transition:
...
.linked-task-block:hover {
  ...
  background: #fff;
  box-shadow:
    0 5px 16px rgba(24, 29, 38, 0.07),
    0 1px 3px rgba(24, 29, 38, 0.04);
}

.linked-task-block.ProseMirror-selectednode {
  border-color: #8fa5ee;
...
.linked-task-block.is-missing .linked-task-title {
  color: #a56a6a;
}

.linked-task-block.is-loading {
  pointer-events: none;
  opacity: 0.62;
}
...
.dark-theme .linked-task-main {
  color: #dce1e7;
}

.dark-theme .linked-task-check {
  border-color: #717e8e;
  background: #171c22;
}
