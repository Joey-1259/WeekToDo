...
.focus-modal-status button:hover {
  background: #eef1f5;
  color: #343a42;
}

.focus-modal-status button:focus-visible {
  outline: none;
...
.dark-theme .focus-modal > header {
  border-color: #30363d;
}

.dark-theme .focus-modal-status > span {
  background: #252c35;
  color: #adb4bd;
}

.dark-theme .focus-modal-status button:hover {
  background: #252c35;
  color: #fff;
}
